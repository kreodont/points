...
<script>
  import GetPoints from '../queries/GetPoints'
  import CreatePoint from '../mutations/CreatePoint'
    ...
    apollo: {
      tasks: {
        ...
        update: data => {
          ...
          return data.allPoint.points.items
        }
      }
    },
  }
